...
class Niveau extends Dessinable{
   ...
   * est cherché par défaut à l'adresse suivante: https://cggteam.github.io/Lode-Runner/assets/maps/
  ...
  lireFichierNiveau(strFichierNiveau) {
    fetch('https://cggteam.github.io/Lode-Runner/assets/maps/' + strFichierNiveau)
